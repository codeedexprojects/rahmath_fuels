      ...
      <section className="py-16 lg:py-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right">
            ...
            >
             Delivering Fuel Safely, On Time, And Reliably.
            </h1>
            ...
            >We provide safe, reliable, and efficient transportation of petroleum products using certified vehicles and trained logistics professionals.</p>
          </div>
