...
import FuelTesting from "../../../assets/Images/FuelTesting.jpg";

import Solar from "../../../assets/Images/solar.jpg";
import BlogMill from "../../../assets/Images/BlogMill.jpg";
...
From Order Placement To Final On-Site Delivery.`,
    ...
    steps: [
      ...
      },
      {
        ...
        desc:
          "Before the fuel leaves the depot, it undergoes laboratory testing to ensure it meets UAE safety and performance standards. Only certified, contamination-free fuel is approved for transportation.",
      },
      {
        num: 3,
      ...
      },
      {
        ...
        desc:
          "Once loaded, the fuel tanker begins its journey. In the UAE, all licensed tankers are equipped with GPS tracking, allowing real-time monitoring of routes and delivery status. Trained and certified drivers ensure safe movement across all emirates.",
      },
      {
        num: 5,
        title: "On-Site Delivery to the Customer",
        desc:
          "Upon arrival, the team conducts safety checks and begins the offloading process using sealed hoses and calibrated meters. Fuel is dispensed directly into storage tanks, generators, or fleet vehicles depending on customer requirements.",
      },
    ],
...
Maintenance Costs, And Unexpected Downtime.`,
   ...
   steps: [
  {
    ...
    desc:
      "Fuel Testing Identifies Harmful Contaminants Such As Water, Sediments, And Microbial Growth That Can Cause Corrosion, Block Fuel Systems, And Lead To Premature Equipment Failure.",
  },
  {
    num: 2,
    title: "Regulatory Compliance",
    desc:
      "Comprehensive Testing Ensures Fuel Meets National And International Quality Standards, Helping Businesses Maintain Regulatory Compliance And Avoid Legal, Safety, And Operational Risks.",
  },
  {
    num: 3,
    title: "Optimized Engine Performance",
    desc:
      "Certified High-Quality Fuel Ensures Efficient Combustion, Enhances Engine Performance, Reduces Emissions, And Supports Consistent Operational Output Across Fleets And Machinery.",
  },
  {
    num: 4,
    title: "Reduced Maintenance Costs",
    desc:
      "Early Identification Of Fuel Quality Issues Helps Prevent Costly Breakdowns, Minimizes Unplanned Downtime, And Significantly Reduces Long-Term Maintenance And Repair Expenses.",
  },
  {
    num: 5,
    title: "Extended Equipment Lifespan",
    desc:
      "Using Clean, Tested Fuel Reduces Internal Wear, Protects Critical Components, And Extends The Operational Lifespan Of Engines, Storage Systems, And Fuel Infrastructure.",
  },
],
...
Cleaner Energy Solutions To Reduce Emissions And Carbon Footprints.`,
   ...
   steps: [
  {
    ...
    desc:
      "Renewable Energy Sources Such As Solar, Wind, And Hydrogen Are Being Actively Integrated Into Transportation Infrastructure To Reduce Dependence On Fossil Fuels And Lower Overall Carbon Emissions.",
  },
  {
    num: 2,
    title: "Adoption of Electric & Hybrid Vehicles",
    desc:
      "Fleet Operators Are Rapidly Transitioning To Electric And Hybrid Vehicles To Improve Energy Efficiency, Reduce Fuel Consumption, And Meet Sustainability And Emissions Reduction Targets.",
  },
  {
    num: 3,
    title: "Smarter Logistics Planning",
    desc:
      "Advanced AI And GPS-Based Route Optimization Enables Smarter Logistics Planning, Minimizing Fuel Usage, Reducing Emissions, And Improving Delivery Efficiency Across Transport Networks.",
  },
  {
    num: 4,
    title: "Government Incentives & Policies",
    desc:
      "Supportive Government Policies, Incentives, And Regulatory Frameworks Encourage Businesses To Adopt Sustainable Transport Solutions And Invest In Clean Mobility Technologies.",
  },
  {
    num: 5,
    title: "Sustainable Fuel Alternatives",
    desc:
      "Cleaner Fuel Alternatives Such As Biofuels And Synthetic Fuels Provide Viable Low-Emission Options That Help Reduce Environmental Impact While Maintaining Performance And Reliability.",
  },
],
